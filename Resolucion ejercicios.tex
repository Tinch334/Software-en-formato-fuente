...
\begin{document}
	...
	Instalamos entonces el primero de entre los que probaba, \texttt{g++}, de la forma \texttt{sudo apt-get install g++}. Esta vez, al correr \texttt{configure} pareci'o lograr mayor progreso que en el intento, pero, de todas formas, la ejecuci'on presentaba un error: \texttt{configure: error: gc.h not found}.
	...
	¡Y efectivamente pudimos visualizar el sitio web sin problemas! Pudimos compilar correctamente \texttt{w3m}.
	...
	\section{Archivos generados}
		...
		\lstset{style=mystyle}
		\lstinputlisting[language=C, title=Archivo \texttt{circulo.c}]{archivos/circulo.c}
		
		\lstinputlisting[language=make, title=Makefile de \texttt{polaca}.]{archivos/makefile_pol.txt}
